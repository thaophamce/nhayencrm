    ...
    <v-card class="design-order-modal">
      <header class="modal-header">
        ...
        <div class="header-copy">
          <h2>Tạo đơn thiết kế mới</h2>
          <p>Điền thông tin đơn, phân công Designer và thiết lập yêu cầu</p>
        </div>
        <v-btn
          icon="mdi-close"
          variant="text"
          ...
          <div class="form-layout">
            <section class="form-card">
              <div class="section-heading">
                <span class="section-icon">
                  <v-icon size="19">mdi-clipboard-text-outline</v-icon>
                </span>
                <div>
                  <h3>Thông tin đơn thiết kế</h3>
                  <p>Mã đơn, số mẫu và thời hạn hoàn thành</p>
                </div>
              </div>
              ...
              <div class="card-content">
                <div class="field-grid two-columns">
                  ...
                  <v-text-field
                    ...
                    type="number"
                    label="Số mẫu thiết kế *"
                    min="1"
                    required
                    :rules="[
                      v => !!v || 'Số mẫu thiết kế là bắt buộc',
                      v => Number(v) > 0 || 'Số mẫu phải lớn hơn 0'
                    ]"
                    variant="outlined"
                    density="comfortable"
                    color="#2F80ED"
            ...
            <section class="form-card">
              <div class="section-heading">
                ...
                <div>
                  <h3>Yêu cầu &amp; trạng thái</h3>
                  <p>Thiết lập quy trình, ghi chú và thuộc tính đơn</p>
                </div>
              </div>
                ...
                <div class="option-list">
                  <label class="option-row urgent" :class="{ active: formData.isUrgent }">
                    ...
                    <span class="option-copy">
                      <strong>Đơn hàng GẤP</strong>
                      <small>Ưu tiên xử lý trước các đơn thông thường</small>
                    </span>
                  </label>

                  <label class="option-row fee" :class="{ active: formData.hasDesignFee }">
                    <v-checkbox
                      v-model="formData.hasDesignFee"
                    ...
                    <span class="option-copy">
                      <strong>Có phí thiết kế</strong>
                      <small>Cộng thêm 100.000đ vào đơn hàng</small>
                    </span>
                  </label>

                  <label
                    v-if="isAdminOrManager"
                    class="option-row outsource"
                    :class="{ active: formData.isOutsource }"
                  >
                    <v-checkbox
                    ...
                    <span class="option-copy">
                      ...
                      <small>Tính KPI Quang Trường</small>
                    </span>
                  </label>
                </div>
              </div>
...
async function submit() {
  ...
  try {
    ...
    toast.error(err.response?.data?.error || 'Có lỗi xảy ra khi tạo đơn hàng');
  } finally {
